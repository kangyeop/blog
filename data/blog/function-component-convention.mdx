...
date: '2026-07-31'
tags: ['학습정리', 'Frontend', 'Convention', 'AI', 'ESLint', 'React']
draft: false
summary: "컴포넌트를 화살표 함수로 쓰는 걸 관행처럼 따라 쓰고 있었다. 그게 어디서 온 건지 확인해본 내용."
authors: ['default']
---

[지난 글](/blog/fsd-vibe-coding/)에서 FSD를 지키게 만드는 방법을 정리했다. 파일이 어디에 놓이는지는 그렇게 어느 정도 정리가 됐다.
